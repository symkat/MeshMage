use utf8;
package MeshMage::DB::Result::Person;
...
Related object: L<MeshMage::DB::Result::AuthPassword>

=cut

__PACKAGE__->might_have(
  "auth_password",
  "MeshMage::DB::Result::AuthPassword",
...
Related object: L<MeshMage::DB::Result::PersonSetting>

=cut

__PACKAGE__->has_many(
  "person_settings",
  "MeshMage::DB::Result::PersonSetting",
  { "foreign.person_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
